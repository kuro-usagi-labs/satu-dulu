...
class RestartCapsules extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RestartCapsules(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> projectId = GeneratedColumn<String>(
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL UNIQUE REFERENCES projects(id)ON DELETE CASCADE',
  );
  ...
  @override
  RestartCapsules createAlias(String alias) {
    return RestartCapsules(attachedDatabase, alias);
  }
...
class DailyCheckIns extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> checkInDate = GeneratedColumn<int>(
    'check_in_date',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class WeeklyReviews extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> decisionAppliedAt = GeneratedColumn<int>(
    'decision_applied_at',
    aliasedName,
    true,
    type: DriftSqlType.int,
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final RestartCapsules restartCapsules = RestartCapsules(this);
